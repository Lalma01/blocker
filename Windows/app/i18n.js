'use strict';
// Shared renderer translations for STRIPARCOP (English / Hungarian).
(function () {
  const DICT = {
    hu: {
      // index
      ...
      // settings
      set_title: 'Beállítások – STRIPARCOP', set_h1: 'Beállítások',
      ...
      // screentime
      st_title: 'Képernyőidő – STRIPARCOP', st_h1: 'Képernyőidő', st_sub: 'Napi képernyőidő-korlát',
      ...
      bl_p: 'A kért weboldal nem felel meg a STRIPARCOP tartalomszűrési házirendjének, ezért a hozzáférést letiltottuk.',
      bl_shield: 'STRIPARCOP · aktív védelem',
      // notification
    ...
    en: {
      ...
      set_title: 'Settings – STRIPARCOP', set_h1: 'Settings',
      ...
      st_title: 'Screen Time – STRIPARCOP', st_h1: 'Screen Time', st_sub: 'Daily screen time limit',
      ...
      bl_p: 'The requested website does not meet the STRIPARCOP content policy, so access has been blocked.',
      bl_shield: 'STRIPARCOP · active protection',
